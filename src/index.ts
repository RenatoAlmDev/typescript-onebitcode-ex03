...
async function main() {
  await fetchUser("renatoalmdev");
  await fetchUser("rafaballerini");
  await fetchUser("tcsizmar");
  await fetchUser("jr-alvs");
  await fetchUser("anacarlapaiva");
  await fetchUser("Leonardo0702");

  await showUser("renatoalmdev");
  await showUser("tcsizmar");
  await showUser("jr-alvs");
